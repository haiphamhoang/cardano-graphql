...
export class HasuraClient {
  ...
  public async getAssetsIncMetadata (): Promise<Asset[]> {
    const result = await this.client.query({
      query: gql`query {
          assets {
              assetId
  ...
  public async getIdsOfAssetsWithoutMetadata (metadataFetchAttempts: IntComparisonExp): Promise<Asset[]> {
    const result = await this.client.query({
  ...
  public addMetadata (metadata: AssetMetadata) {
    this.logger.info('adding metadata to asset', { module: 'HasuraClient', value: metadata.subject })
  ...
  public incrementMetadataFetchAttempts (assetId: Asset['assetId']) {
    this.logger.info('incrementing asset metadata fetch attempt', { module: 'HasuraClient', value: assetId })
    return this.client.mutate({
